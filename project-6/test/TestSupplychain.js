...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        const eventUpc = events[0].returnValues['upc'];
        ...
        assert.equal(upc, eventUpc, 'Invalid event emitted')        
    })    
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Mark an item as Processed by calling function processtItem()
        const ownerBeforeBalance  =  await web3.eth.getBalance(originFarmerID);

        await supplyChain.buyItem(upc, { from:distributorID, value:productPrice})

        const ownerAfterBalance  =  await web3.eth.getBalance(originFarmerID);
        ...
        assert.equal(parseFloat(ownerAfterBalance), parseFloat(ownerBeforeBalance)+ parseFloat(productPrice), 'Error: Invalid productPrice')
